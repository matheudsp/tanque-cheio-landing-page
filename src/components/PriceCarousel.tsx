        ...
        <div className="embla__container pb-4">
          {slides.map((fuel) => (
            <div className="embla__slide" key={fuel.name}>
              {/* === Card Criativo e Único === */}
              <div className="group relative bg-brand-background-paper rounded-2xl shadow-lg border border-brand-border/20 h-full flex flex-col transition-all duration-300 overflow-hidden hover:border-brand-secondary-main/50">
                ...
                <div className="p-6 z-10 flex flex-col h-full">
                    ...
                    <div className="relative flex justify-between items-center w-full">
                      ...
                      <div className="text-center">
                        ...
                        <p className="mt-2 text-brand-success font-semibold font-mono text-lg">
                          R$<CountingNumber number={fuel.min} decimalPlaces={2} decimalSeparator="," />
                        </p>
                      </div>
                      {/* Ponto Máximo (Vermelho) */}
                      <div className="text-center">
                        ...
                        <p className="mt-2 text-brand-error font-semibold font-mono text-lg">
                           R$<CountingNumber number={fuel.max} decimalPlaces={2} decimalSeparator="," />
                        </p>
                      </div>
                    </div>
                  </div>
                  
                  {/* Caixa de Economia (O grande destaque) */}
                  <div className="bg-brand-secondary-main text-white rounded-xl p-4 mt-auto text-center flex items-center justify-center gap-4">
                    ...
                    <div className="text-left">
                      <p className="font-semibold text-sm opacity-90">Sua economia chega a</p>
                      <p className="text-3xl font-extrabold font-mono">
                        R$<CountingNumber number={fuel.diff} decimalPlaces={2} decimalSeparator="," />
                        <span className="text-lg font-medium align-baseline">{fuel.measureUnit}</span>
                      </p>
                    </div>
                  </div>
                </div>
